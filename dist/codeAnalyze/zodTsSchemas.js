...
import { z } from 'zod';
// Local Imports
import { tsCompStr, tsCompTypes, } from '../init.js';
// Exports
/**
...
export const decompSchema = z.object({
    ...
    }).describe('The object description of the exported declaration')).describe(`Array of exported TypeScript descriptions`)
});
